...
const static int SCSI_DELAY_POWER_ON_TO_SELECTION_TIME_S = 10;
const static int SCSI_DELAY_RESET_TO_SELECTION_TIME_US = 250 * 1000;
const static int SCSI_DELAY_RESET_HOLD_TIME_US = 25;
const static int SCSI_DELAY_SELECTION_ABORT_TIME_US = 200;
const static int SCSI_DELAY_SELECTION_TIMEOUT_DELAY_NS = 250 * 1000;
