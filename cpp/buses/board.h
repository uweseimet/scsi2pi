...
static constexpr int PIN_ATN_MASK = 1U << PIN_ATN;
static constexpr int PIN_RST = 20;
static constexpr int PIN_RST_MASK = 1U << PIN_RST;
static constexpr int PIN_ACK = 21;
static constexpr int PIN_ACK_MASK = 1U << PIN_ACK;
static constexpr int PIN_REQ = 22;
static constexpr int PIN_REQ_MASK = 1U << PIN_REQ;
static constexpr int PIN_MSG = 23;
static constexpr int PIN_MSG_MASK = 1U << PIN_MSG;
static constexpr int PIN_CD = 24;
static constexpr int PIN_CD_MASK = 1U << PIN_CD;
static constexpr int PIN_IO = 25;
static constexpr int PIN_IO_MASK = 1U << PIN_IO;
static constexpr int PIN_BSY = 26;
static constexpr int PIN_BSY_MASK = 1U << PIN_BSY;
static constexpr int PIN_SEL = 27;
static constexpr int PIN_SEL_MASK = 1U << PIN_SEL;
