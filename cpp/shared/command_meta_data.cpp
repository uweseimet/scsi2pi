...
CommandMetaData::CommandMetaData()
{
    ...
    AddCommand(scsi_command::read_reverse, 6, "READ REVERSE(6)", { 4, 1, 1, 3, false });
    ...
    AddCommand(scsi_command::verify_6, 6, "VERIFY(6)", { 4, 1, 1, 3, true });
    AddCommand(scsi_command::mode_select_6, 6, "MODE SELECT(6)", { 4, 1, 0, 0, true });
    AddCommand(scsi_command::reserve_reserve_element_6, 6, "RESERVE(6)(RESERVE ELEMENT(6)", { 0, 0, 0, 0, false });
    AddCommand(scsi_command::release_release_element_6, 6, "RELEASE(6)/RELEASE ELEMENT(6)", { 0, 0, 0, 0, false });
    ...
    AddCommand(scsi_command::write_and_verify_10, 10, "WRITE AND VERIFY(10)", { 7, 2, 2, 4, true });
    ...
    AddCommand(scsi_command::write_long_10, 10, "WRITE LONG(10)", { 7, 2, 0, 0, true });
    AddCommand(scsi_command::write_same_10, 10, "WRITE SAME(10)", { 7, 2, 0, 0, true });
    ...
    AddCommand(scsi_command::reserve_reserve_element_10, 10, "RESERVE(10)/RESERVE ELEMENT(10)", { 7, 2, 0, 0, true });
    AddCommand(scsi_command::mode_select_10, 10, "MODE SELECT(10)", { 7, 2, 0, 0, true });
    AddCommand(scsi_command::release_release_element_10, 10, "RELEASE(10)/RELEASE ELEMENT(10)", { 7, 2, 0, 0, true });
    ...
    AddCommand(scsi_command::persistent_reserve_in, 10, "PERSISTENT RESERVE IN", { 7, 2, 0, 0, false });
    AddCommand(scsi_command::persistent_reserve_out, 10, "PERSISTENT RESERVE OUT", { 7, 2, 0, 0, true });
    AddCommand(scsi_command::write_filemarks_16, 16, "WRITE FILEMARKS(16)", { 0, 0, 0, 0, false });
    AddCommand(scsi_command::rebuild_read_reverse_16, 16, "REBUILD(16)/READ REVERSE(16)", { 0, 0, 0, 0, false });
    AddCommand(scsi_command::read_16, 16, "READ(16)", { 10, 4, 2, 8, false });
    AddCommand(scsi_command::write_16, 16, "WRITE(16)", { 10, 4, 2, 8, true });
    AddCommand(scsi_command::write_and_verify_16, 16, "WRITE AND VERIFY(16)", { 10, 4, 2, 8, true });
    ...
    AddCommand(scsi_command::synchronize_cache_space_16, 16, "SYNCHRONIZE CACHE(16)/SPACE(16)", { 0, 0, 0, 0, false });
    AddCommand(scsi_command::locate_16, 16, "LOCATE(16)", { 0, 0, 0, 0, false });
    AddCommand(scsi_command::erase_write_same_16, 16, "ERASE(16)/WRITE SAME(16)", { 0, 0, 0, 0, false });
    ...
    AddCommand(scsi_command::read_12, 12, "READ(12)", { 6, 4, 2, 4, false });
    AddCommand(scsi_command::write_12, 12, "WRITE(12)", { 6, 4, 2, 4, true });
    AddCommand(scsi_command::write_and_verify_12, 12, "WRITE AND VERIFY(12)", { 6, 4, 2, 4, true });
    AddCommand(scsi_command::verify_12, 12, "VERIFY(12)", { 6, 4, 2, 4, true });
