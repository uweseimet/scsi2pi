...
TEST(CommandDispatcherTest, DispatchCommand)
{
    ...
    command_default_folder.set_operation(PbOperation::DEFAULT_FOLDER);
    ...
    command_default_image_files_info.set_operation(PbOperation::DEFAULT_IMAGE_FILES_INFO);
    ...
    PbCommand command_image_file_info;
    command_image_file_info.set_operation(PbOperation::IMAGE_FILE_INFO);
    SetParam(command_image_file_info, "file", "");
    CommandContext context_image_file_info(command_image_file_info, "", "");
    EXPECT_FALSE(dispatcher.DispatchCommand(context_image_file_info, result, ""));
    ...
    command_shut_down.set_operation(PbOperation::SHUT_DOWN);
    ...
    command_create_image.set_operation(PbOperation::CREATE_IMAGE);
    ...
    command_delete_image.set_operation(PbOperation::DELETE_IMAGE);
    ...
    command_rename_image.set_operation(PbOperation::RENAME_IMAGE);
    ...
    command_copy_image.set_operation(PbOperation::COPY_IMAGE);
    ...
    command_protect_image.set_operation(PbOperation::PROTECT_IMAGE);
    ...
    command_unprotect_image.set_operation(PbOperation::UNPROTECT_IMAGE);
