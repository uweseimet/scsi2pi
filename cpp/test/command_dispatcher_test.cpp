...
TEST(CommandDispatcherTest, DispatchCommand)
{
    ...
    CommandContext context_invalid(command_invalid, *default_logger());
    ...
    CommandContext context_default_folder(command_default_folder, *default_logger());
    ...
    CommandContext context_log_level1(command_log_level, *default_logger());
    EXPECT_FALSE(dispatcher.DispatchCommand(context_log_level1, result));
    SetParam(command_log_level, "level", "invalid:32");
    CommandContext context_log_level2(command_log_level, *default_logger());
    ...
    CommandContext context_server_info(command_server_info, *default_logger());
    ...
    CommandContext context_version_info(command_version_info, *default_logger());
    ...
    CommandContext context_log_level_info(command_log_level_info, *default_logger());
    ...
    CommandContext context_image_file_info1(image_support_file_info1, *default_logger());
    ...
    CommandContext context_mapping_info(command_mapping_info, *default_logger());
    ...
    CommandContext context_statistics_info(command_statistics_info, *default_logger());
    ...
    CommandContext context_operation_info(command_operation_info, *default_logger());
    ...
    CommandContext context_reserved_ids_info(command_reserved_ids_info, *default_logger());
    ...
    CommandContext context_shut_down(command_shut_down, *default_logger());
    ...
    CommandContext context_create_image(command_create_image, *default_logger());
    ...
    CommandContext context_delete_image(command_delete_image, *default_logger());
    ...
    CommandContext context_rename_image(command_rename_image, *default_logger());
    ...
    CommandContext context_copy_image(command_copy_image, *default_logger());
    ...
    CommandContext context_protect_image(command_protect_image, *default_logger());
    ...
    CommandContext context_unprotect_image(command_unprotect_image, *default_logger());
